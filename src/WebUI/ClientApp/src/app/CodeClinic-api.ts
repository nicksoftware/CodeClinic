...
export interface ILikesClient {
    createLike(commentId: number, command: CreateLikeCommand): Observable<FileResponse>;
    updateLike(id: number | undefined, commentId: string, command: UpdateLikeCommand): Observable<FileResponse>;
    deleteLike(commentId: string, command: DeleteLikeCommand): Observable<FileResponse>;
}
...
export class LikesClient implements ILikesClient {
    ...
    createLike(commentId: number, command: CreateLikeCommand): Observable<FileResponse> {
        let url_ = this.baseUrl + "/api/likes/{CommentId}/Likes";
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processCreateLike(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processCreateLike(<any>response_);
                } catch (e) {
                    return <Observable<FileResponse>><any>_observableThrow(e);
                }
            } else
    ...
    protected processCreateLike(response: HttpResponseBase): Observable<FileResponse> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    updateLike(id: number | undefined, commentId: string, command: UpdateLikeCommand): Observable<FileResponse> {
        ...
        return this.http.request("put", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processUpdateLike(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processUpdateLike(<any>response_);
                } catch (e) {
                    return <Observable<FileResponse>><any>_observableThrow(e);
                }
            } else
    ...
    protected processUpdateLike(response: HttpResponseBase): Observable<FileResponse> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    deleteLike(commentId: string, command: DeleteLikeCommand): Observable<FileResponse> {
        ...
        return this.http.request("delete", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processDeleteLike(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processDeleteLike(<any>response_);
                } catch (e) {
                    return <Observable<FileResponse>><any>_observableThrow(e);
                }
            } else
    ...
    protected processDeleteLike(response: HttpResponseBase): Observable<FileResponse> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
...
export class UpdateLikeCommand implements IUpdateLikeCommand {
    likeId?: number;

    constructor(data?: IUpdateLikeCommand) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): UpdateLikeCommand {
        data = typeof data === 'object' ? data : {};
        let result = new UpdateLikeCommand();
        result.init(data);
        return result;
    }
...
export interface IUpdateLikeCommand {
    likeId?: number;
}

export class DeleteLikeCommand implements IDeleteLikeCommand {
    likeId?: number;

    constructor(data?: IDeleteLikeCommand) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): DeleteLikeCommand {
        data = typeof data === 'object' ? data : {};
        let result = new DeleteLikeCommand();
        result.init(data);
        return result;
    }
...
export interface IDeleteLikeCommand {
    likeId?: number;
}
